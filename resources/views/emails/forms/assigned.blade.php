                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="padding: 30px 30px 0;">
                                            ...
                                            <p>As part of <b>{{ config('app.name') }}</b>, we kindly ask you to complete the attached <a href="{{ route('forms.index') }}" target="_blank"><b>{{ $data['form']->name }}</b></a> form. Your prompt attention to this matter will help us ensure we have the most accurate and up-to-date information to provide you with the best possible care.</p>
                                        </td>
                                    </tr>
