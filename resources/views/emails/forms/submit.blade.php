...
<html>
    <head>
        ...
        <title>Form Values Submitted</title>
    </head>
    <body>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="text-align: left; padding: 30px 30px 40px;">
                                            <p style="text-align: left;line-height: 24px;">Please let me know if you need any additional information or if there are any further steps required.</p>
