...
<link href="{{ url('public/admin/build/css/custom.css') }}" rel="stylesheet">
<link href="{{ url('public/css/sweetalert2.css') }}" rel="stylesheet">
<link href="{{ url('public/css/flag-icon.min.css') }}" rel="stylesheet">
